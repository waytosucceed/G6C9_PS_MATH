...
const uniqueKey = "Estimation And Their Product";
...
function loadQuestion(index) {
  ...
  randomQuestion.options.forEach(function(option, idx) {
    ...
    if (option.image) {
      ...
      optionImage.style.width = "95%"; // Adjust width to fit two images per row
optionImage.style.maxWidth = "600px"; // Optional max width
